# Gaumukh Tapovan Trek - Source Packet Review

> Facts below come from source-derived `trek_facts`; Playwright only confirms rendered UI structure.

- Trek ID: `gaumukh-tapovan`
- Source URL: https://indiahikes.com/gaumukh-tapovan
- Has `#complete-trek-information`: `True`
- Observed UI keys: `best_time, camping, detailed_itinerary, difficulty, faqs, fitness, other, packing, quick_itinerary, stay, travel`
...
- Packet section ID: `gaumukh-tapovan::best_time_section::001`
- Source field: `best_time_section`
- Section type: `text_section`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Best Time To Do Gaumukh Tapovan Trek Schedule Your Trek Dates Based on the Best Season toggle accordion; Best Time To Do Gaumukh Tapovan Trek`
...
image
https://images.prismic.io/indiahike/d484c4bd-c245-452e-8649-e27631afb801_Gaumukh+-+Harshith+Sai+Kosaraju+-+A+view+of+the+mighty+Bhagirathi+peaks_+the+Gaumukh+glacier+at+the+base+of+the+peak%2C+the+Bhagirathi+river+and+the+Bhojbasa+campsite%2C+covered+with+fresh+snow+early+in+the+morning.jpeg?auto=format,compress
Bhojbasa campsite in winter
4032
3024
YifTARIAAB0AlCcp
0
...
image
https://images.prismic.io/indiahike/8d846b6d-15d7-4f85-b1bf-172e62e79a12_Gaumukh+Tapovan_Sooraj+Kumar_View+of+Mount+Shivling+at+Tapovan.jpg?auto=format,compress
Mt Shivling
Indiahikes_Sooraj Kumar_Gaumukh Tapovan
1600
1200
YifTPRIAAB0AlCgy
0
...
- Packet section ID: `gaumukh-tapovan::day_wise_itinerary::001`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Does Each Day Look Complete Trek Guide with Photos toggle accordion; How Does Each Day Look`
- Matched anchors: `detailed-itinerary`

```text
{
  "day": "1",
  "place_title": "Day 1 (Pick-up Day): Reach Gangotri",
  "difficulty": "Moderate ascent. Well-marked road followed by forest trails.",
  "duration": "Drive Duration: 10-12 hours drive from Dehradun to Gangotri",
  "altitude": "Altutide: 10,050 ft",
  "water_sources": "",
  "description": "The trek begins at Gangotri the following morning.  Gangotri is known as the source of the river Ganga (the actual source being Gaumukh), which is known as Bhagirathi here.\nIt is said that King Bhagirath prayed to Lord Shiva for the salvation of the souls of his 60,000 sons. Shiva obliged and requested Goddess Ganga to release her water, which purified the ashes of Bhagirath’s sons. This mythological story elevated the status of the River Ganga as a means to purify one’s soul."
}
```

### Day 2: Trek from Gangotri to Chirbasa

- Packet section ID: `gaumukh-tapovan::day_wise_itinerary::002`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Does Each Day Look Complete Trek Guide with Photos toggle accordion; How Does Each Day Look`
...
{
  "day": "5",
  "place_title": "Day 5: Trek from Tapovan to Bhojbasa",
  "difficulty": "Moderate Difficult. Level trail to Chirbasa.",
  "duration": "Trek Duration: 5 hours | Trek Distance: 6km",
  "altitude": "Altitude loss: 14,203 ft (4,328 m) to 12,415 ft (3789 m)",
  "water_sources": "Water Sources: Carry 2 litres of water.  You can refill your water bottles at streams along the trail.",
  "description": "From the campsite, begin your descent to Bhojbasa. Follow the same route that you climbed up. You will cross the same boulder section and a stream. Continue climbing down, and you will have a traverse section. Make sure to keep an eye out for falling rocks. Do not rest here.\nContinue walking on the path. You will cross the landslide-prone area. Here, the Bhagirathi massif looms closer into view. Continue walking on the same path. From here on, keep a lookout for the trolley to cross the Bhagirath river.\nStay in tents for the night at the Bhojbasa campsite."
}
```

### Day 6: Trek from Bhojbasa to Gangotri

- Packet section ID: `gaumukh-tapovan::day_wise_itinerary::006`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Does Each Day Look Complete Trek Guide with Photos toggle accordion; How Does Each Day Look`
...
{
  "day": "6",
  "place_title": "Day 6: Trek from Bhojbasa to Gangotri",
  "difficulty": "Moderate.",
  "duration": "Trek Duration: 8 hours | Trek Distance: 14 km",
  "altitude": "Altitude loss: 12,415 ft (3789 m) to 10,050 ft (3065 m)",
  "water_sources": "Water Sources: Carry 2L of water. None from Bhojbasa to Chirbasa. You can refill your water bottles from streams on the way from Chirbasa to Gangotri.",
  "description": "Proceed from Bhojbasa on the same trail back to Gangotri.\nThe trek involves a gradual descent and a series of level walks, which can be done swiftly. It’s a very gradual descent, which takes far less time to cover than the ascent.\nThough this is a gradual descent, keep in mind that it is still a 14 km trail, which might feel endless."
}
```

### Day 7: Drive from Gangotri to Dehradun

- Packet section ID: `gaumukh-tapovan::day_wise_itinerary::007`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Does Each Day Look Complete Trek Guide with Photos toggle accordion; How Does Each Day Look`
...
{
  "day": "7",
  "place_title": "Day 7: Drive from Gangotri to Dehradun",
  "difficulty": "",
  "duration": "Drive Duration: 8 hours | Drive Distance: 242 km",
  "altitude": "",
  "water_sources": "",
  "description": "Drive back from Gangotri to Dehradun. \nCab cost per vehicle will be Rs 8500 (5-6 seater) and Rs 14,000 (10-12 trekkers). You will reach Dehradun between 6.00 pm and 7.00 pm."
}
```

### Day 8: Buffer Day

- Packet section ID: `gaumukh-tapovan::day_wise_itinerary::008`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Does Each Day Look Complete Trek Guide with Photos toggle accordion; How Does Each Day Look`
...
{
  "day": "8",
  "place_title": "Day 8: Buffer Day",
  "difficulty": "",
  "duration": "",
  "altitude": "",
  "water_sources": "",
  "description": "This depends completely on the weather conditions on the trek and the call will be taken by the trek leader.\nIf the buffer day is used,  you have to pay us Rs. 2,500 per day (INR) +5% GST. The money will be collected by the Trek Leader only if we use the buffer day"
}
```

### Difficulty Section

- Packet section ID: `gaumukh-tapovan::difficulty_section::001`
- Source field: `difficulty_section`
- Section type: `text_section`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How Difficult Is Gaumukh Tapovan Trek What You Can Expect in terms of Terrain, Altitude, Weather and Safety toggle accordion; How Difficult Is Gaumukh Tapovan Trek`
- Matched anchors: `uncontrolled-tab-example-tabpane-Day 4; uncontrolled-tab-example-tabpane-Day 5; trek-difficulty`
...
1665
1249
https://images.prismic.io/indiahike/aEkehrNJEFaPX2TP_difficultyicon_moderatedifficult.png?auto=format,compress
aEkehrNJEFaPX2TP
0
1
transparent
You will cover a total of around 41 km in six trekking days during which you will gain approximately 4,153 ft (10,050 ft to 14,203 ft). Every day will include ascents and descents. There are several difficult sections on this trek that require you to be alert and trek carefully.
Terrain:
On the way to Chirbasa from Gangotri, you cross a large boulder. On one side, it drops directly into the river. Be extra careful even though there are guard rails, especially if it rains.
Between Chirbasa and Bhojbasa, the unstable "Kachha Dhaang" sections are prone to landslides.
After Bhojbasa, crossing the Bhagirathi River requires government-provided trolleys. Handle the pulley carefully to avoid injury.
The final ascent to Tapovan is along the lateral moraines of Gangotri glacier and is rockfall-prone.
...
Altitude:
Gangotri, situated 10,050 ft above sea-level, is our highest basecamp. This makes you susceptible to Acute Mountain Sickness (AMS).
The trek takes you over 14,000 ft over sea-level at Tapovan. At altitudes above 10,000 ft, the chances of being hit by Acute Mountain Sickness are real. Altitude sickness can happen to anybody - first-time trekkers as well as experienced trekkers. Fitness helps in making your trek easier. But do not forget that even a fit person climbing too high too soon runs an equal risk of developing AMS. Here’s a Complete guide to Acute Mountains Sickness, HAPE and HACE
...
Emergency Exits:
The only exit point on the Gaumukh Tapovan Trek is Gangotri (basecamp). With only one exit point on the trail, evacuation in case of emergency becomes challenging on the Gaumukh Tapovan trek.
There is an SDRF camp and Forest Department Office at Bhojbasa. In case of emergency, they can be approached for help and rescue. Mules or horses can also be arranged to take you from Bhojbasa to Gangotri.
Ahead of Bhojbasa, evacuation from Tapovan is extremely difficult because of the terrain and the difficult sections that come into play.
Closest Hospital to the Gaumukh Tapovan Trek:
...
<image_carousel>difficult_section_images</image_carousel>
...
### Are backpacks, raincoats, and other equipment available for rent on Gaumukh Tapovan trek?

- Packet section ID: `gaumukh-tapovan::faqs::001`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
```text
Q: Are backpacks, raincoats, and other equipment available for rent on Gaumukh Tapovan trek?
A: We do have ponchos, backpacks, shoes, and trekking poles available for rent. You can order them online here.
```

### What is the best time to do Gaumukh Tapovan trek?

- Packet section ID: `gaumukh-tapovan::faqs::002`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
A: May to July and September to October are the best months for the Gaumukh Tapovan trek.
```

### What will the temperatures be like on Gaumukh Tapovan trek?

- Packet section ID: `gaumukh-tapovan::faqs::003`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: What will the temperatures be like on Gaumukh Tapovan trek?
A: The Gaumukh Tapovan trek can be done in two seasons- Summer and Autumn.
...
- Packet section ID: `gaumukh-tapovan::faqs::004`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: How Difficult is the Gaumukh Tapovan Trek?
A: How Difficult Is The Gaumukh Tapovan Trek| Indiahikes| Tips To Prepare | Trek Talk With Vishnu Benne
...
### How fit do you need to be for Gaumukh Tapovan?

- Packet section ID: `gaumukh-tapovan::faqs::005`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: How fit do you need to be for Gaumukh Tapovan?
A: A Himalayan trek like Gaumukh Tapovan requires a good fitness level. The trek has long climbs and steep descents daily. As a measure of your fitness, we need you to:
...
- Packet section ID: `gaumukh-tapovan::faqs::006`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
A: Before you register for the trek, we would like you to understand the challenges, and the fitness required.
...
### Will I get a mobile network and charging points during the Gaumukh Tapovan Trek?

- Packet section ID: `gaumukh-tapovan::faqs::007`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: Will I get a mobile network and charging points during the Gaumukh Tapovan Trek?
A: When it comes to a mobile phone network and an internet connection, you’ll find a good network until Gangotri. Airtel, BSNL, and Jio are the mobile phone connections you will most likely get. However, once you leave Gangotri, the network is spotty or non-existent.
...
### How many months in advance should I book Gaumukh Tapovan?

- Packet section ID: `gaumukh-tapovan::faqs::008`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: How many months in advance should I book Gaumukh Tapovan?
A: Gaumukh Tapovan is a trek with a very short window. It is only trekkable in the summer (May-June) and autumn (Mid-Sep to Mid-Oct), a total of hardly three months. Slots for this trek get filled months before the season. It's ideal for you to book this trek 3 to 4 months in advance.
```

### How long is the Gaumukh Tapovan Trek?

- Packet section ID: `gaumukh-tapovan::faqs::009`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: How long is the Gaumukh Tapovan Trek?
A: Gaumukh Trek covers 46 km trek over 6 days (8 days including the drive to and from the trek). The altitude ranges from 10,050 ft in Gangotri all the way to Tapovan at 14,203 ft.
```

### Where is the nearest ATM?

- Packet section ID: `gaumukh-tapovan::faqs::010`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
### How many trekkers are in this group?

- Packet section ID: `gaumukh-tapovan::faqs::011`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: How many trekkers are in this group?
A: On the Gaumukh Tapovan trek, Indiahikes usually take 23 trekkers in total.
```

### Can I keep extra luggage at the base camp?

- Packet section ID: `gaumukh-tapovan::faqs::012`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
A: We have a cloakroom facility at the base camp (Gangotri), where you can leave your excess luggage behind. You can collect it once you are back at the base camp.
...
- Packet section ID: `gaumukh-tapovan::faqs::013`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: Will there be snow on this trek?
A: In early summers, you will find snow along the trail. This is also the time when you cross the Bhagirathi river over the natural snow bridges. The snow remains till Gaumukh and sometimes even beyond until the mid of May.
...
### Is offloading available for the Gaumukh Tapovan trek?

- Packet section ID: `gaumukh-tapovan::faqs::014`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: Is offloading available for the Gaumukh Tapovan trek?
A: Having more footprints through porters or mules on any trail isn’t good for the ecosystem. Keeping this and the spirit of trekking in mind, there will be no offloading available on this trek. Unless it is due to a medical issue. The cost of offloading your backpack is Rs 4,000 for the entire trek pre-tax.
Check out ways to make carrying your backup easier
```

### I am a foreign national. Will I have to pay any extra charges to go on this trek?

- Packet section ID: `gaumukh-tapovan::faqs::015`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Frequently Asked Questions Get your questions answered here toggle accordion; Frequently Asked Questions`
...
```text
Q: I am a foreign national. Will I have to pay any extra charges to go on this trek?
A: Yes, you do. The state tourism department charges slightly higher fees for foreign trekkers to issue permits for this trek. You need to carry an extra amount of Rs 1,000. Additionally carry 4-5 copies of your passport along with your VISA.
```

### Fitness Section

- Packet section ID: `gaumukh-tapovan::fitness_section::001`
- Source field: `fitness_section`
- Section type: `text_section`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `How to Get Fit for the Gaumukh Tapovan Trek A 6-Week Plan to Help You Get Trek-Fit for the Gaumukh Tapovan Trek toggle accordion; How to Get Fit for the Gaumukh Tapovan Trek`
...
embed
https://www.youtube.com/watch?v=VR3l-GH0HhU
video
1.0
...
Fitness Target
To do the Gaumukh Tapovan Trek comfortably, you must be able to walk, jog or run 5 km in under 32 minutes. This is the minimum recommended fitness level that you must aim for.
image
...
A 6-Week Plan to Help You Get Trek-Fit for the Gaumukh Tapovan Trek
image
https://images.prismic.io/indiahike/Z44JNpbqstJ99n7F_ModerateDifficultRunning_FitnessTable.jpg?auto=format,compress
Gaumukh Tapovan Running Fitness Plan
3000
1688
Z44JNpbqstJ99n7F
0
1
transparent
(6-Week Fitness Plan: Running)
image
https://images.prismic.io/indiahike/Z44JK5bqstJ99n69_ModerateDifficultWalking_FitnessTable.jpg?auto=format,compress
Gaumukh Tapovan Walking Fitness Plan
3000
1688
Z44JK5bqstJ99n69
0
...
image
https://images.prismic.io/indiahike/Z44JLJbqstJ99n6-_ModerateDifficult_StrengthTrainingTable.jpg?auto=format,compress
3000
1688
Z44JLJbqstJ99n6-
0
...
Note:
Alternatives to 40 Standard Pushups = (4 x 20 = 80 knee pushups) = (4 x 40 = 160 wall pushups)
Alternative to 60 full squats = (4 x 30 = 120 half squats)
...
Important note: We accept only running, jogging or walking as fitness proofs. Cross-training workouts will not be considered valid. We've suggested cross training options to help keep your fitness journey engaging and fun, allowing you to explore activities you enjoy and to avoid inconsistency. So make sure to record at least 3 runs from the last 1 month to meet the fitness criteria of the trek.
Note: Use apps like Nike and Strava to record your runs consistently.
...
embed
https://www.youtube.com/watch?v=WZocACEsJbk&t=1s
video
1.0
...
embed
https://www.youtube.com/watch?v=AGgg2Dv1Y6Y&t=3s
video
1.0
...
Instances we may reject your fitness record:
If you fail to link your fitness profile
If you do not meet the required fitness level at least three times in the past month
Important Notes:
Children below 14 years are not required to submit fitness records.
However, parents must ensure that children remain physically active and prepared for the trek.
Any
```

### Packing Section

- Packet section ID: `gaumukh-tapovan::packing_section::001`
- Source field: `packing_section`
- Section type: `text_section`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Packing List Things To Take toggle accordion; Packing List`
- Matched anchors: `what-to-pack; trek-what-to-pack`

```text
Packing Checklist
image
https://images.prismic.io/indiahike/aDyB5bh8WN-LVdQK_GaumukhTapovan-V2-.jpg?auto=format,compress
1600
aDyB5bh8WN-LVdQK
0
1
transparent
Given below is a list of all the gear you need for the Gaumukh Tapovan trek:
...
- Packet section ID: `gaumukh-tapovan::quick_info::001`
...
```text
{
  ...
  "trek_duration": "8 days / 41 km",
  "highest_altitude": "14,203 ft",
  "suitable_for": "12 to 62 years",
  "basecamp": "Gangotri, Uttarakhand",
  "accommodation_type": "Tents (2-sharing)",
  "fitness_criteria": "5 km in 32 mins",
  "pickup_details": "Asli Pappu Da Dhaba, Dehradun at 5.00 AM",
  "dropoff_details": "Asli Pappu Da Dhaba, Dehradun at 8.00 PM",
...
- Packet section ID: `gaumukh-tapovan::quick_itinerary::001`
...
{
  "day": "1",
  "heading": "Reach Gangotri from Dehradun",
  "sub_heading": "Drive distance: 242 km | Drive Duration: 8 hours",
  "details": "Transport will be arranged from ,Asli Pappu Da Dhaba, Dehradun at 5.00 am. The transport cost is ₹1550 (additional 5% GST) per trekker (one-way) (₹3100 for both onward and return journeys). These are non-AC vehicles. Please pre-book your transport through the dashboard before your trek."
}
```

### Day 2

- Packet section ID: `gaumukh-tapovan::quick_itinerary::002`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "2",
  "heading": "Trek from Gangotri (10,050 ft) to Chirbasa (11,630 ft)",
  "sub_heading": "Trek Distance: 10 km | Trek Duration: 6 hours",
  "details": "Moderate. Initial 300 m steep ascent followed by a very gradual ascent all the way."
}
```

### Day 3

- Packet section ID: `gaumukh-tapovan::quick_itinerary::003`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "3",
  "heading": "Chirbasa (11,630 ft) to Bhojbasa (12,415 ft)",
  "sub_heading": "Trek Distance: 5 km | Trek Duration: 3 hours",
  "details": "Moderate. Initial 100 m ascent to get back on the trail. Very gradual ascent all the way to Bhojbasa"
}
```

### Day 4

- Packet section ID: `gaumukh-tapovan::quick_itinerary::004`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "4",
  "heading": "Bhojbasa (12,415 ft) to Tapovan (14,203 ft)",
  "sub_heading": "Trek Distance: 6 km | Trek Duration: 9 hours",
  "details": "Difficult. Gradual ascent for 2.5 hours. 2 hours glacier walk followed by 1 hour of moderate ascent. Final 1.5 hours is a steep ascent."
}
```

### Day 5

- Packet section ID: `gaumukh-tapovan::quick_itinerary::005`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "5",
  "heading": "Tapovan (14,203 ft) to Bhojbasa (12,415 ft)",
  "sub_heading": "Trek Distance: 6 km | Trek Duration: 5 hours",
  "details": "Moderate Difficult. Level trail to Chirbasa."
}
```

### Day 6

- Packet section ID: `gaumukh-tapovan::quick_itinerary::006`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "6",
  "heading": "Bhojbasa (12,415 ft) to Gangotri (10,050 ft)",
  "sub_heading": "Trek Distance: 14 km | Trek Duration: 8 hours",
  "details": "Tricky descent over bouldery section"
}
```

### Day 7

- Packet section ID: `gaumukh-tapovan::quick_itinerary::007`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
{
  "day": "7",
  "heading": "Drive from Gangotri to Dehradun",
  "sub_heading": "Drive distance: 242 km | Drive Duration: 8 hours",
  "details": "The transport cost is ₹1550 (additional 5% GST) per trekker (one-way) (₹3100 for both onward and return journeys). These are non-AC vehicles. Please pre-book your transport through the dashboard before your trek.\nPlease note: The distance between campsites may vary by 100 meters depending on the weather conditions and the route you take. The altitude may also vary by 100 feet for similar reasons.\nDrop Location and Time: Asli Pappu Da Dhaba, Dehradun at 8.00 pm"
}
```

### Day 8

- Packet section ID: `gaumukh-tapovan::quick_itinerary::008`
- Source field: `quick_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
- Matched UI labels: `Quick Itinerary Get your trek plan toggle accordion; Quick Itinerary`
...
```text
{
  "day": "8",
  "heading": "Buffer Day",
  "sub_heading": "If the buffer day is used,  you have to pay us Rs. 2,500 per day (INR) +5% GST. The money will be collected by the Trek Leader only if we use the buffer day.",
  "details": "This depends completely on the weather conditions on the trek and the call will be taken by the trek leader."
}
```
