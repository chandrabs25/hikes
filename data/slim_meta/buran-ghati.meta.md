# Buran Ghati Trek - Slim Trek Meta

> Metadata-ready source layer for LLM extraction. No facts are inferred here.

- Trek ID: `buran-ghati`
- Source URL: https://indiahikes.com/buran-ghati
- Source packet: `buran-ghati.packet.json`
- Sections: `25`
...
```json
{
  ...
  "trek_duration": "8 days / 40.5 km",
  "highest_altitude": "15,000 ft",
  "suitable_for": "12 to 62 years",
  "basecamp": "Janglik, Himachal Pradesh",
  "accommodation_type": "Tents (2-sharing)",
  "fitness_criteria": "5 km in 32 mins",
  "pickup_details": "Shaktan Homestay Rohru at 9.30 AM",
  "dropoff_details": "Shimla Old Bus Stand at 11 PM",
  "cloakroom": "Available",
...
- Section ID: `buran-ghati::best_time_section::001`
- Source field: `best_time_section`
- Section type: `seasonality`
- Rendered support: `rendered_structure_matched`

```text
When you take out all the best parts of our Himalayan treks and stitch them together to make one perfect trek, that’s the Buran Ghati trek. But to appreciate its beauty, you need to time it properly. This section will help you do that.
There are two great seasons to do the Buran Ghati trek — summer and autumn.
#fff
Buran Ghati in Summer (mid-May to end of June)
Day time temperature: Between 13 °C and 17 °C | Night time temperature: Will drop to zero at higher campsite
Presence of snow: You will find snow at the Litham campsite in May. During June, you can expect snow at the last alpine campsite of Dhunda.
...
Presence of snow: You can expect frost at the campsite of Dhunda. There are chances of snowfall at the Buran Ghati Pass when weather goes bad.
...
What Is The Best Time To Do The Buran Ghati Trek | Indiahikes | Trek With Swathi
Indiahikes
YouTube
<iframe width="200" height="113" src=" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen title="What Is The Best Time To Do The Buran Ghati Trek | Indiahikes | Trek With Swathi"></iframe>
```

### Day 1 (Pick-up Day): Drive from Rohru to Janglik

- Section ID: `buran-ghati::day_wise_itinerary::001`
...
- Section ID: `buran-ghati::difficulty_section::001`
...
You will cover a total of around 40.5 km in seven trekking days, during which you will gain approximately 5,585 ft (9,415 ft to 15,000 ft). Every day will include ascents, descents. You’ll need to negotiate boulder sections near the pass. This is a trek that demands good preparation and stamina.
The Terrain:
You start the trek at an altitude of over 9000 ft. This is higher than usual. Your body takes time to get used to the altitude which can add to the challenge of the trek.
Beyond Dhunda, the trail climbs steeply to the pass. And you need to navigate this ascent at an altitude of over 13,000 ft above sea-level. This can be taxing.
Just after the pass-crossing, you need to navigate a boulder field. While this may be covered in snow in May, expect to face the boulders anytime from June onwards. You need good preparation and strong legs to tackle this.
While approaching the River campsite, the last camp is a small exposed section that overlooks a river, where you need to be careful while traversing.
...
Weather:
Early in the season, expect a lot of snow ahead of Litham. This makes the situation more difficult than usual. We will give you microspikes but you need to be careful and tread with caution.
After the pass-crossing, you will have to negotiate steep snowy slopes. Sometimes you can slide, sometimes not. Wear microspikes before stepping on hard snow to prevent slips and injuries. Use existing footholds; avoid making new paths. Indiahikes' technical team will guide trekkers and create footholds. Ropes will be used if the snow is weak.
Heavy rainfall or snow can alter a lot of dynamics. Rain can flood the trails or make them too slushy to walk safely on. Snowfall can obstruct previously made paths, requiring fresh tracks to be cut on the snow.
...
Altitude:
The trek involves an altitude gain of 5,585 ft (9,415 ft to 15,000 ft) over seven trekking days. You start high, at over 9000 ft above sea-level and on most days you gain almost 2000 ft in altitude.
...
Closest Hospital to the Buran Ghati Trek:
...
- Section ID: `buran-ghati::faqs::001`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Can I keep extra luggage at the base camp of Janglik?
A: There's an option to leave excess luggage behind in Rohru which comes during your journey from Shimla to the basecamp. After the trek, your cloakroom luggage will be handed over to you in Rampur.
...
- Section ID: `buran-ghati::faqs::002`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How do I book for my stay on the last day after the trek at Shimla?
A: Booking stays at Shimla can be a bit tricky. There are two options we would suggest.
...
- Section ID: `buran-ghati::faqs::003`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: What is buffer day on this trek?
A: At Indiahikes, we understand the time, energy, and efforts that you put into preparing for a trek.
...
- Section ID: `buran-ghati::faqs::004`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Will there be rappelling from the Buran Pass during my trek?
A: If you are going during the summer months of May and June, then you will rappel down on an ice wall at Buran Pass, which is at 15,000 feet.
...
- Section ID: `buran-ghati::faqs::005`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
A: The last place you’ll find a mobile phone signal is Janglik. There is Vodafone/Airtel network at Janglik.
...
### How many months in advance should I book the Buran Ghati trek?

- Section ID: `buran-ghati::faqs::006`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How many months in advance should I book the Buran Ghati trek?
A: Buran Ghati is a popular trek. Getting last-minute slots for this trek is impossible. So if you are keen on trekking to Buran Ghati, plan and register for the trek at least 2 months in advance. This will also give you adequate time to prepare for the trek.
```

### Is Buran Ghati a good first Himalayan trek?

- Section ID: `buran-ghati::faqs::007`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Is Buran Ghati a good first Himalayan trek?
A: Yes, if you are really fit. Buran Ghati is a moderate-difficult trek. For this, you ideally need prior high-altitude trek experience. That will help you enjoy the trek better.
...
### Which is the nearest ATM to the Buran Ghati trek?

- Section ID: `buran-ghati::faqs::008`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Which is the nearest ATM to the Buran Ghati trek?
A: Rohru is the last town where you’ll find ATMs to make cash withdrawals. It lies about 40 km before Janglik. All major public and private sector banks have their ATMs at Rohru. Therefore, Rohru is your best option if you want to withdraw cash. Post that there are no ATMs.
...
### What will the weather be like on Buran Ghati trek?

- Section ID: `buran-ghati::faqs::009`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: What will the weather be like on Buran Ghati trek?
A: Buran Ghati Trek can be done in two seasons — Summer and Autumn. The summer season starts in mid-May and continues until the end of June. It might even stretch to the first week of July. Then the trek closes for the monsoon season.
...
- Section ID: `buran-ghati::faqs::010`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How long is Buran Ghati trek?
A: Buran Ghati is not a very long trek. A total distance of 37 km is covered in 5 trekking days. On average a day, you cover about 7 km.
...
- Section ID: `buran-ghati::faqs::011`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
- Section ID: `buran-ghati::faqs::012`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
But if — due to a medical condition — you are unable to carry your own backpack, the total cost of offloading on this trek is Rs 4,800 for the entire trek. Check out ways to make carrying your backpack easier
```

### Is Rentals available for the Buran Ghati trek?

- Section ID: `buran-ghati::faqs::013`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Is Rentals available for the Buran Ghati trek?
A: Yes, the rentals are available for the Buran Ghati trek. Head over to the Indiahikes rentals website to know more about what gears you can rent.
```

### How do I plan my travel to Rohru?

- Section ID: `buran-ghati::faqs::014`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How do I plan my travel to Rohru?
A: Book your air tickets to either Delhi or Chandigarh for Day Zero, which is the day before Day 1 on the itinerary. From there, you'll get buses to Rohru. For a detailed explanation of how to plan your travel, click here.
```

### Fitness

- Section ID: `buran-ghati::fitness_section::001`
...
Fitness Target
To do the Buran Ghati Trek comfortably, you must be able to walk, jog or run 5 km in under 32 minutes. This is the minimum recommended fitness level that you must aim for.
...
A 6-Week Plan to Help You Get Trek-Fit for the Buran Ghati Trek
Buran Ghati Running Fitness Table
(6-Week Fitness Plan: Running)
Buran Ghati Walking Fitness Table
