# Deoriatal Chandrashila Trek - Slim Trek Meta

> Metadata-ready source layer for LLM extraction. No facts are inferred here.

- Trek ID: `deoriatal-chandrashila-trek`
- Source URL: https://indiahikes.com/deoriatal-chandrashila-trek
- Source packet: `deoriatal-chandrashila-trek.packet.json`
- Sections: `24`
...
```json
{
  ...
  "trek_duration": "6 days / 32 km",
  "highest_altitude": "12,083 ft",
  ...
  "pickup_details": "Live free hostel, Rishikesh at 7.00 AM",
  "dropoff_details": "Live free hostel, Rishikesh at 6.00 PM",
  "cloakroom": "Available",
...
- Section ID: `deoriatal-chandrashila-trek::best_time_section::001`
...
- Section ID: `deoriatal-chandrashila-trek::day_wise_itinerary::001`
...
{
"day": "4",
"place_title": "Day 4: Trek from Syalmi to Baniya Kund",
"difficulty": "Difficulty: Easy-moderate. An hour of descending till Akashkamini river, followed by a steep ascent through dense forest. And after an hour of climbing, you will see the first Chaniya and from there, it’s a series of ascent and descend till Baniya Kund.",
"duration": "Trek Duration: 6 hours | Trek DIstance: 5.4 km",
"altitude": "Altitude Gain: 7600 ft to 8,520 ft",
"water_sources": "Highlights: The whole day's setting is so pretty, that you might want to take some time to soak it in. The forest again is very dense. Fill in your water bottles and drink from the cold natural streams of the Akashkamini river.",
"description": "Start off in the south-east direction from the Syalmi campsite. The trail descends rapidly to Akash Kamini, a rivulet coming from Chandrashila. Pause here and take some photos by this gurgling stream. It takes 20-30 minutes to reach the stream. Replenish your water supplies here. There is a small bridge to cross.\nNote: This bridge gets washed away in case of heavy rains. But if the water level is low, it can be crossed without the help of a bridge.\nFrom here, take the trail that now ascends gradually with a series of three scissor bends. As you climb up, the view of the valley gets better and better. Around 20 minutes of the steady climb will take you to a small meadow called Shamkhudi Bugyal.\nThere is a series of shepherd huts here made of stones. In summer, you will find locals occupying the huts with their livestock. Continue further to reach a nursery of medicinal plants. After about 10 minutes of descent through a jungle trail, you would come upon a road head. Walk for another 100 metres to reach the Baniya Kund campsite."
}
```

### Day 5: Trek from Baniya Kund to Chandrashila Peak via Tungnath and drive back to Sari from Chopta

- Section ID: `deoriatal-chandrashila-trek::day_wise_itinerary::005`
- Source field: `day_wise_itinerary`
- Section type: `itinerary_day`
- Rendered support: `rendered_structure_matched`
...
{
"day": "6",
"place_title": "Day 6: Drive from Sari to Rishikesh",
"difficulty": "Driving Distance: 190 km",
"duration": "Drive Duration: 7-8 hours | Driving Distance: 190 km",
"altitude": "",
"water_sources": "",
"description": "Board your cabs from here for a drive back to Rishikesh. You will reach Rishikesh between 3:00 to 4:00 pm.\nCab costs will be approximately Rs 8,000 per Bolero and Rs 12,000 per Tempo Traveler on the way back."
}
```

### Difficulty

- Section ID: `deoriatal-chandrashila-trek::difficulty_section::001`
...
You will cover a total of around 32 km in four trekking days during which you will gain approximately 5,523 ft (6,560 ft to 12,083 ft). Every day will include ascents and descents. But, they are mostly gradual and steady, except for the summit climb on Day 5.
The Terrain:
Trekking on the Deoriatal Chandrashila trail in winter can be tricky. Your final high-altitude camp before you attempt the Chandrashila summit is Baniyakund. As you leave the campsite early in the morning, the snow will be hard, having frozen overnight. This snow section continues until you get to the Chandrashila summit, getting steeper as you approach the summit.
...
Weather:
The Chandrashila summit is known for fast and strong winds. So make sure you are well-layered.
Rainfall or snowfall, lasting for hours, can change the entire trek dynamic. Rain can flood the trails or make them too slushy to walk safely. Snowfall can obstruct previously made paths, requiring fresh tracks to be cut on the snow.
In the Autumn season, the temperatures may plummet below zero. Layering well is the key.
...
Altitude:
Even though the Chandrashila summit is at an altitude of 12,083 ft, the climb is gradual. This makes acclimatisation easy. Yet, stay prepared.
...
Emergency Exits:
There are multiple entry and exit points throughout the trek.
Chopta-Baniyakund roadhead to Sari
Rohini Bugyal via Baniyakund/Chopta to Sari
Closest Hospital to the Deoriatal Chandrashila Trek:
The closest hospital is in Ukimath, which is about 15 km by road from Sari. However, for any advanced treatment, heading to Dehradun is the best option. However, for major medical emergencies, the nearest hospital is in Mussoorie, which is almost 8-9 hours away from the base camp of the trek.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::001`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How long is Chandrashila trek?
A: The Deoriatal Chandrashila covers around 27 km in 4 days. (6 days including the drive to and from the trek). The altitude ranges from 6,560 ft in Sari all the way to Chandrashila top at 12,083 ft.
```

### How difficult is the Chandrashila trek?

- Section ID: `deoriatal-chandrashila-trek::faqs::002`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How difficult is the Chandrashila trek?
A: The Deoriatal Chandrashila trek is a moderate one. It does not have too many steep climbs (except the summit push to Chandrashila). It does not have many long days.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::003`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: What is the best time to do the Deoriatal Chandrashila trek?
A: The Deoriatal Chandrashila trek is great all year round. But the best time to do the trek is hands-down, the months of March and April. This is when you’ll still see snow on the trek, but you’ll also see blossoming Himalayan rhododendrons.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::004`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Is there snow in Chandrashila?
A: There is snow on the Chandrashila trek from December to the end of April. The first winter snowfalls by mid-December, and the trail usually remains accessible till the end of December.
Between January and February, which are peak winter months, the trails become difficult to access because of very high snow. We would suggest the Chandrashila trek in these months if snow is what you are looking for.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::005`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How fit do I need to be to do the Deoriatal Chandrashila trek?
A: A trek like Deoriatal Chandrashila requires a good fitness level. There are gradual ascents, steep ascent to the top and 5-6 hours of trekking every day. As a measure of your fitness, we need you to:
Run at least 5 km in 35 minutes before your trek. It's our minimum mandatory requirement. Once you get confirmed for your trek, we will diligently follow up on your fitness routine. Our team will also assist in putting you through a fitness plan. It will ultimately help you have a safe trek experience.
How to Get Fit for Your Trek
```

### Is Chopta safe?

- Section ID: `deoriatal-chandrashila-trek::faqs::006`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
```text
Q: Is Chopta safe?
A: Chopta is safe for trekkers and tourists. It is quite trekker-friendly, with guesthouses and homestays. Since it is in a remote location, expect basic facilities here.
...
### Can I take my child on the Deoriatal-Chandrashila trek?

- Section ID: `deoriatal-chandrashila-trek::faqs::007`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Can I take my child on the Deoriatal-Chandrashila trek?
A: If your child is above 10 years, yes, we would highly recommend the Deoriatal-Chandrashila trek. They will have a mix of easy and challenging trails.
On the other hand, if your child is below 10, avoid this trek. The second day and the summit day are very long. We have seen very young children below 10 struggle or fail to complete the trek because of the exertion.
```

### How many trekkers are in a single group?

- Section ID: `deoriatal-chandrashila-trek::faqs::008`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: How many trekkers are in a single group?
A: On the Deoriatal Chandrashila Trek, we usually take around 20- 23 trekkers in total.
```

### What are the washroom/toilet facilities like on the trek?

- Section ID: `deoriatal-chandrashila-trek::faqs::009`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
### Will I get a mobile network and charging points during the Deoriatal Chandrashila Trek?

- Section ID: `deoriatal-chandrashila-trek::faqs::010`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Will I get a mobile network and charging points during the Deoriatal Chandrashila Trek?
A: When it comes to a mobile phone network and an internet connection, you’ll find a good network all across your trek. You will get a 4G network even at Chandrashila Top!
As for electricity, Sari Campus is the last point with electricity. At the Indiahikes base camp in Sari, all the rooms are equipped with plug points for trekkers to charge their electronic devices.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::011`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Can I keep extra luggage at the base camp in Sari?
A: Yes, you can keep the extra luggage at the base camp. Once the trek ends, you will be able to collect the luggage. Our team will arrange for this.
...
- Section ID: `deoriatal-chandrashila-trek::faqs::012`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
A: Deoriatal Chandrashila is a 6-day trek. You will be staying at our campus in Sari and in tents on other days of the trek. Each tent accommodates 2 trekkers.
```

### I am more than 62 years old. Can I do this trek?

- Section ID: `deoriatal-chandrashila-trek::faqs::013`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`
...
- Section ID: `deoriatal-chandrashila-trek::faqs::014`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Is offloading available for this trek?
A: Having more footprint through porters, horses or mules on any trail isn’t good for the ecosystem. This is why, at Indiahikes, we do not encourage offloading. A trekker carries his/her own backpack in the true spirit of trekking.
But if — due to a medical condition — you are unable to carry your own backpack, you may offload your backpack.
The cost of offloading on the Deoriatal Chandrashila trek is Rs 1,600 for the trek pre-tax.
Find details about the offloading process here.
```

### Where is the closest hospital to the base camp?

- Section ID: `deoriatal-chandrashila-trek::faqs::015`
- Source field: `faqs`
- Section type: `faq`
- Rendered support: `rendered_structure_matched`

```text
Q: Where is the closest hospital to the base camp?
A: Rudraprayag Government Hospital, Rudraprayag, Uttarakhand is the closest hospital to the base camp (Sari).
There is another hospital in Ukhimath. But we do not recommend this as it does not have many basic facilities.
```

### Fitness

- Section ID: `deoriatal-chandrashila-trek::fitness_section::001`
...
It works on the same muscles you use while trekking—your calves, glutes, quads and hamstrings. It also mimics your foot movement so you are better prepared for sudden twists and turns you may go through on uneven terrain.
Here’s Why Running is the Best Exercise To Get Fit for a Trek
Fitness Target
To do the Deoriatal Chandrashila Trek comfortably, you must be able to walk, jog or run 5 km in under 35 minutes. This is the minimum recommended fitness level that you must aim for.
